 /*  flash [up to 4 level] neopixel LEDs at various brain wave entraining freq-
  * uencies and colors; brightness adjusts with pot. v. B -- he adds binary
...
// How many leds to control? up to 4 data chunk
#define NUM_LEDS 4
...
void loop()
{ // count enables pulsing of flash bursts: flash (count max)-1, 
  // then dark for pulse*period
  static byte count = 1;
  if (count == 6) count = 1;
