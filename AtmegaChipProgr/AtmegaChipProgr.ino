...
// make some of these false (the ones you don't want) to reduce compile size.
// The Atmega328 is always included (Both Uno and Lilypad).
...
/* ----------------------------------------------------------------------------
WARNING: The Arduino Leonardo, Arduino Esplora and the Arduino Micro all use the same chip 
(ATmega32U4).
