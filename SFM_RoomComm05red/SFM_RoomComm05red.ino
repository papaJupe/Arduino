...
/* SFM RoomComm05  -- working R control from iOS/Andr
  ...
  see sensor data on the Roo. To operate, Enable R by grnding DD, or button,
...
void setup() {
  ...
  SimbleeForMobile.deviceName = "RooComRed";
