...
//     2016-04-30  -- AM mod for FRC board use

#ifndef _ADXL345_H_
#define _ADXL345_H_

#include "I2Cdev.h"
      // ALT pin 12 ? accessible on FRC bd as D0?, ? set hi;
#define ADXL345_ADDRESS_ALT_LOW    0x53   // = (83)  7 bit addr used by Spark_ & Ada_ 
#define ADXL345_ADDRESS_ALT_HIGH    0x1D // (29) <-- 7 bit FRC alt address pin (hi?)
#define ADXL345_DEFAULT_ADDRESS   ADXL345_ADDRESS_ALT_HIGH  // for FRC bd
         // device value  -- register that holds it
...
#define ADXL345_RATE_800            0b1101  // ret val of 13 = 800 hz meas rate
#define ADXL345_RATE_400            0b1100
#define ADXL345_RATE_200            0b1011
#define ADXL345_RATE_100            0b1010  // default, returns 10, corresp. to 100 hz
...
class ADXL345 
{
    public:
        ADXL345();  // default
        ADXL345(uint8_t address); // if you send another address for prog to send to (devAddr var)
 
        void initialize();
        bool testConnection();

        // DEVID register
        uint8_t getDeviceID();   // devID held in reg 0x00, should be 0xE5 (229) for ADXL345
