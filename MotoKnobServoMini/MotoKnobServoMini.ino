...
/* MotoKnobServoMini -- Mead's mod to control a motor speed or servo using map function
  ...
  mod for Nano uses Anal pins for ground/5v of pot; my defective nanos can't handle servo and Serial in same sketch!
*/
