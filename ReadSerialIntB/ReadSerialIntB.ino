/* 
 ...
 ReadSerIntB puts incoming digits one by one, into a String object then str.toInt() to convert. Version C
 extracts first group of digits from the serial input into an array then atoi to make the int
...
{   
  ...
  { 
    ...
    else if (gotOne)   // yes, and flush() does not do it
      { 
